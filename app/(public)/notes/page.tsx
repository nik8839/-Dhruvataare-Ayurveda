    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
        <div className="container mx-auto px-4 py-8">
          <Link
            href="/"
            className="inline-flex items-center space-x-2 text-purple-600 hover:text-purple-800 mb-6 font-semibold transition-colors"
          >
          ...
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400 rounded-lg p-8 text-center shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-2">No Notes Content Yet</h3>
            <p className="text-gray-600 text-lg">Check back soon for comprehensive study notes!</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Link
          href="/"
          className="inline-flex items-center space-x-2 text-purple-600 hover:text-purple-800 mb-8 font-semibold transition-all hover:translate-x-1"
        >
          <FiArrowLeft className="w-5 h-5" />
        ...
        <div className="text-center mb-12">
          <div className="inline-block p-4 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl mb-4 shadow-lg">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Comprehensive notes organized by year and subject
          </p>
          <div className="w-32 h-1.5 bg-gradient-to-r from-purple-500 to-pink-600 mx-auto mt-6 rounded-full"></div>
        </div>

        {/* Years Grid */}
        {Object.entries(taxonomy).map(([yearKey, yearData]: any) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {yearData.subjects && yearData.subjects.map((subject: string, index: number) => {
                ...
                return (
                  <Link
                    key={subject}
                    href={`/notes/${yearKey}/${subject.toLowerCase().replace(/ /g, '-').replace(/&/g, 'and')}`}
                    ...
                    <div className="relative p-8">
                      <div className="flex items-center space-x-4 mb-6">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-white/80 text-sm mt-1">View study notes</p>
                        </div>
                      </div>
                      
                      <div className="flex items-center justify-between mt-6 pt-6 border-t border-white/20">
                        <span className="text-sm font-bold text-white/90 uppercase tracking-wider">Explore Notes</span>
        ...
        <div className="relative overflow-hidden rounded-2xl shadow-2xl mt-12">
          ...
          <div className="relative p-10 text-center">
            ...
            <Link
              href="/community"
              className="inline-flex items-center space-x-2 bg-white text-purple-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-pink-50 transition-all transform hover:scale-105 shadow-lg"
            >
              <span>Join Now</span>
